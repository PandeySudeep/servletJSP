...
<html>
	...
	<head>
		...
		<title>Post Room/Accomodation</title>
	...
	<body>
		...
		<div class="container">
			...
			<article>
				<form style="width:40%" action="postroom" method="POST">
					...
					<div class="form-group">
						...
						<textarea name="roomdesc" cols="50" rows="5" class="form-control" required></textarea>	
					</div>
					<div class="form-group">
						<label>Location</label>
						<input type="text" name="roomlocation" class="form-control" required>
					</div>
					<div class="form-group">
						<label>Country</label>
					...
					<button type="submit" class="btn btn-primary">Post Available Accomodation</button>
				</form>
			</article>
