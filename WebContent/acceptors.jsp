			...
			<article>
				<form style="width:40%" action="profileshow" method="POST">
					<div class="form-group">
						<label>Select Profie ID Below To View Profile That Accepted You</label>
						<input type="text" name="desiredprofile" class="form-control" required>
						<button type="submit" class="btn btn-primary">View</button>
					</div>
				</form>		
				<form action="sendmsgtoacceptor" method="POST">
					<div class="form-group">
						<label>Select Profie ID Below To Send Email</label>
						<input type="text" name="acceptor_id" class="form-control" required>
						<label>Email Message</label>
						<textarea name="msg" cols="50" rows="5" class="form-control" required></textarea>	
				...
				<div style="margin-top:10px" class="table-responsive">
					<table class="table table-striped">
						...
						ArrayList<MilanProfile> l = (ArrayList<MilanProfile>)request.getAttribute("list_of_acceptors");
						int size = l.size();%>
