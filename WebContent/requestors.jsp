			...
			<article>
				<form style="width:40%" action="profileshow" method="POST">
					<div class="form-group">
						<label>Select Profie ID To View</label>
						<input type="text" name="desiredprofile" class="form-control" required>
						<button type="submit" class="btn btn-primary">View</button>
					</div>
					</form>
					<form style="width:40%" action="finalresponse" method="POST">
						<div class="form-group">
							<label>Profile ID For Response</label>
							<input type="text" name="requestorprofileid" class="form-control" required>
							<label>Response</label>	
								<select type="text" name="decision" class="form-control" required>
									<option value="ACCEPTED">I ACCEPT</option>
									<option value="DECLINED">I DECLINE</option>
								</select>
				...
				<div style="margin-top:10px" class="table-responsive">
					<table class="table table-striped">
						...
						<%ArrayList<MilanProfile> l = (ArrayList<MilanProfile>)request.getAttribute("list_of_requestors");
						int size = l.size();%>
