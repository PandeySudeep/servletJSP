		...
		<div class="container">
			...
			<nav>
				...
				<ul>
					...
					<li><a href="pay_job_pst.jsp">Post a Job</a></li>
					<li><a href="post_accom.jsp">Post Room/Accomodation</a></li>
				</ul>
				<ul>
					<li><a href="search_jobs.jsp">Search for Job</a></li>
					<li><a href="search_rooms.jsp">Search Room/Accomodation</a></li>
				</ul>
				<ul>
					<li><a href="profprofile.jsp">Create Professional Profile</a></li>
					<li><a href="sendemailprofs.jsp">Send Email to Professionals</a></li>
				</ul>
				<!-- <ul>
					<li><a href="emailtoall.jsp">Send Email to all Nepalese</a></li>
				</ul>-->
				
				<ul>
					<div class="list-group">
						<a style="color:red;font-weight:bold" href="#" class="list-group-item disabled">Marketing App</a>
						<a href="hamro_biz.jsp" class="list-group-item">Market your product/service/event/news</a>
				...
				<ul>
					<div class="list-group">
						...
						<a href="paytocreate" class="list-group-item">Welcome and please proceed to <br> the dating/matrimony community.</a>
