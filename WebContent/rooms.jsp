...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<article>
				<h1 id="tableheader">Accomodation Availability for Selected Date Range</h1>
				<div style="margin-top:10px" class="table-responsive">
					<table class="table table-striped">
						<tr>
							...
							<%ArrayList<Room> l = (ArrayList<Room>)request.getAttribute("listofrooms");
							int size = l.size();%>
  							<%for(int i=0;i<size;i++){%>
								<tr>
									<td><%out.print(l.get(i).getPosted_date());%></td>
									<td><%out.print(l.get(i).getPosted_by());%></td>
									<td><%out.print(l.get(i).getRoom_desc());%></td>
